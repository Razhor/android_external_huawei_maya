...
e4defrag_cflags := -O2 -g -W -Wall \
    ...
    -DHAVE_FALLOCATE64 \
    -DHAVE_SYSCONF
e4defrag_shared_libraries := \
    libext2fs \
    libext2_com_err \
    libext2_e2p \
    libcutils
e4defrag_system_shared_libraries := libc

include $(CLEAR_VARS)
LOCAL_SRC_FILES := $(e4defrag_src_files)
LOCAL_C_INCLUDES := $(e4defrag_c_includes)
LOCAL_CFLAGS := $(e4defrag_cflags)
LOCAL_SHARED_LIBRARIES := $(e4defrag_shared_libraries)
LOCAL_SYSTEM_SHARED_LIBRARIES := $(e4defrag_system_shared_libraries)
...
# 
include $(CLEAR_VARS)
LOCAL_POST_INSTALL_CMD := echo "aaaaaaaaaaaaaaaaaa"
LOCAL_SRC_FILES := mntenttest.c
LOCAL_CFLAGS := -O2 -g -W -Wall
LOCAL_FORCE_STATIC_EXECUTABLE := true
LOCAL_STATIC_LIBRARIES := libc
LOCAL_MODULE := mntenttest
LOCAL_MODULE_TAGS := optional
...
LOCAL_SHARED_LIBRARIES := $(filefrag_shared_libraries)
LOCAL_SYSTEM_SHARED_LIBRARIES := $(filefrag_system_shared_libraries)
LOCAL_MODULE := filefrag
LOCAL_MODULE_TAGS := optional
...
e2freefrag_src_files := \
    e2freefrag.c

e2freefrag_c_includes := \
    external/e2fsprogs/lib

e2freefrag_cflags := -O2 -g -W -Wall \
    -DHAVE_UNISTD_H \
    -DHAVE_ERRNO_H \
    -DHAVE_NETINET_IN_H \
    -DHAVE_SYS_IOCTL_H \
...
e2freefrag_shared_libraries := \
    libext2fs \
    libext2_com_err \
    libext2_e2p

e2freefrag_system_shared_libraries := libc

include $(CLEAR_VARS)

LOCAL_SRC_FILES := $(e2freefrag_src_files)
LOCAL_C_INCLUDES := $(e2freefrag_c_includes)
LOCAL_CFLAGS := $(e2freefrag_cflags)
LOCAL_SHARED_LIBRARIES := $(e2freefrag_shared_libraries)
LOCAL_SYSTEM_SHARED_LIBRARIES := $(e2freefrag_system_shared_libraries)
LOCAL_MODULE := e2freefrag
LOCAL_MODULE_TAGS := optional
